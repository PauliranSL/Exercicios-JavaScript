...
const my3FavoriteTVShows = ['Supernatural' , 'Band of Brothers' , 'Chernobyl']
...
console.log(`A string que a "typeSentence" armazena tem mais de ${numberCheck} caracteres? ${String(typeSentence.length >39).replace('t','T')}.`);
