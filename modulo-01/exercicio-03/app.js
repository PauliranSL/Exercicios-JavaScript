...
let joinDogName = dogNames.join(', ')
console.log(joinDogName);
...
const dessert = `${dogNames[0].slice(3,5)}${dogNames[1].slice(2,5)}${dogNames[3].slice(2,4)}`

console.log(dessert);

const dessertString = dessert.replace('n','d');
console.log(dessertString);

console.log(`A ${dessertString} é um doce à base de coco, tradicional na América Latina e em Angola.`);
